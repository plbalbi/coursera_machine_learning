...
% The values of mu and sigma coming from featureNormalize are column vectors
prediction_input = [1 1650 3];
disp(prediction_input);
prediction_input = (prediction_input - [0 mu])./[1 sigma];
disp(prediction_input);
price = prediction_input*theta; % You should change this
